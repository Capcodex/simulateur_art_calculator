...
function calcA(dev, commission, tvaActive) {
...
function bandedRateEuroPerCm2(area) {
    if (area <= 500)
        return 7.94; // XS
    if (area <= 1000)
        return 5.99; // S
...
function getRate2d(area) {
    var niveau = selVal('niveau2d');
    if (niveau === 'perso')
        return toNum('multPerso2d'); // override direct
    var base = bandedRateEuroPerCm2(area);
    if (niveau === 'emergent')
        return base * LVL.emergent;
    if (niveau === 'intermediaire')
        return base * LVL.intermediaire;
    return base * LVL.etabli; // établi ou vide
}
// Méthode B (2D/3D)
function calcB(dev, commission, tvaActive) {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var bloc2d = document.getElementById('bloc2d');
    function syncType() {
    ...
    var niveau2dSel = document.getElementById('niveau2d');
    var blocMultPerso2d = document.getElementById('blocMultPerso2d');
    ...
    var tauxSel = document.getElementById('tauxHoraire');
    var blocTauxPerso = document.getElementById('blocTauxPerso');
    ...
    var edSel = document.getElementById('edition');
    var edCount = document.getElementById('editionCountBlock');
